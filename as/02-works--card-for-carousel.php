<section class="frt-section-works">
	<div class="dg-w" style="overflow-x:scroll"><!-- работает карусель -->
		<div class="dg-ww frt-ww--cards" style="padding-left:0;padding-right:0;width:9999px"><!-- работает карусель -->
			<h2 class="dg-title frt-title">Наши <span class="frt-title__underline">работы</span></h2>
			<ul class="dg-set dg-set--flexbox  dg-flexbox dg-flexbox--JC-flex-start">
				<li class="dg-li">
